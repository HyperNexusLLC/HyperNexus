...
NEW_NAME="hypernexus"
OLD_GIT_URL="https://gitlab.com/hypernexus-org/HyperNexus.git"
NEW_GIT_URL="https://gitlab.com/hypernexus-org/HyperNexus.git"
OLD_MODULE="gitlab.com/hypernexus-org/HyperNexus"
NEW_MODULE="gitlab.com/hypernexus-org/HyperNexus"
...
if [ -f start.sh ]; then
	...
	sed -i "s|gitlab.com/hypernexus-org/HyperNexus|$NEW_MODULE|g" start.sh
