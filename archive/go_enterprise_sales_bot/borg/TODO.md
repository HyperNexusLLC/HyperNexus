...
- [ ] **Git LFS**: Consider tracking large `.db` files (provider_metrics.db 145MB, hypernexus.db 34MB) with Git LFS to avoid repo bloat.
...
- [ ] **Deep Link Protocol**: Expand `hypernexus://` protocol for browser-to-kernel attachment.
