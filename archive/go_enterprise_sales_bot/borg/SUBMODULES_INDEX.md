...
| **marketing_agent** | `marketing_agent/` | `robertpelloni/marketing_agent` | `fdafa92` (main) | Enterprise sales bot with nested hypernexus submodule |
| **hypernexus** (nested) | `marketing_agent/hypernexus/` | `robertpelloni/hypernexus` | `f3314909` (main) | Core OS module, tracks HyperNexus main |
...
- **hypernexus** — Memory ingestion (fully ported to Go MemoryManager)
...
├── marketing_agent/    # Submodule: sales bot + nested hypernexus
