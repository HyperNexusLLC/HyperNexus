...
- module: `gitlab.com/hypernexus-org/HyperNexus-go`
- module: `gitlab.com/hypernexus-org/HyperNexus`
- top-level layout:
...
| `submodules/hypernexus` | Experimental external CLI harness/upstream assimilation lane |
| `submodules/hypernexus-mcp` | External HyperNexus MCP reference lane |
