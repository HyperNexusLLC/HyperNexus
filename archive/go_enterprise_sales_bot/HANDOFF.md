...
| **hypernexus.site** | Skull jaw lowered + grin widened, nose shifted down, nasal cavity shrunk inward, hero padding reduced, both jaws adjusted |
...
- `hypernexus` submodule has modified content (not committed — separate repo)
...
2. Verify hypernexus.site skull animations render correctly
3. Push remaining submodule updates if hypernexus is ready
