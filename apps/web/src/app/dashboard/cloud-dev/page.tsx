...
const CATEGORY_DESC: Record<string, string> = {
  ...
  "browser-extension": "Bridge to the HyperNexus browser extension: save web memories, parse DOM content, and manage browser-extension stored data.",
  ...
  imports: "Import external sessions from Claude, Gemini, Aider, and other AI coding tools into the HyperNexus memory system.",
...
export default function GenericDashboardPage() {
  ...
  const desc = CATEGORY_DESC[path.split("/").pop() || ""] || `Browse ${pageName} data from the HyperNexus API.`;
