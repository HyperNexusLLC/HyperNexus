	...
	return (
		<div className="p-6">
			<h1 className="text-2xl font-bold mb-6">
				Project Architecture & Submodules
			</h1>
							...
							<tbody className="divide-y divide-zinc-700 text-zinc-300">
								...
								{submodules && submodules.length === 0 && (
									<tr>
										...
										>
											No submodules found (.gitmodules empty)
										</td>
									</tr>
								)}
							</tbody>
...
function GraphVisualizer() {
	...
	if (isLoading)
		return <div className="text-zinc-500">Loading Intelligence Graph...</div>;
	...
	return (
		<div className="space-y-2">
			<div className="text-zinc-500 italic text-sm">
				Auto-test service is currently disabled. Enable the{" "}
				<code className="bg-zinc-800 px-1 rounded">autoTest</code> router in{" "}
				<code className="bg-zinc-800 px-1 rounded">trpc.ts</code> to activate
				file-save-triggered testing.
			</div>
