...
async function install() {
	console.log("");
	console.log("  ⚡ HyperNexus Installer");
	console.log("  =========================");
	console.log("");
	...
	try {
		...
		const localBinary = path.join(binDir, platform.binary);
		if (fs.existsSync(localBinary)) {
			console.log(`  Binary already exists: ${localBinary}`);
			console.log("");
