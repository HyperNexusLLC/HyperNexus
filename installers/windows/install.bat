...
:: Create corporate branding config
echo  [4/6] Configuring corporate mode...
(
echo {
echo   "edition": "hypernexus",
echo   "product_name": "HyperNexus",
echo   "company_name": "HyperNexus Corp",
echo   "tray_tooltip": "HyperNexus (Running)",
echo   "dashboard_title": "HyperNexus Dashboard",
echo   "cloud_endpoint": "https://cloud.hypernexus.site",
echo   "config_dir": ".hypernexus",
echo   "registry_key": "HyperNexus"
echo }
) > "%CONFIG_DIR%\branding.json"

:: Set environment variables for corporate mode
setx HN_EDITION "corporate" >nul 2>&1
setx HN_CLOUD_ENDPOINT "https://cloud.hypernexus.site" >nul 2>&1
set HN_EDITION=corporate
set HN_CLOUD_ENDPOINT=https://cloud.hypernexus.site
echo        OK - Corporate mode enabled
echo        OK - Cloud endpoint: cloud.hypernexus.site
echo.
