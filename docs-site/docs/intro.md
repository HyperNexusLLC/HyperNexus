...
- **Windows**: Download `hypernexus-setup.exe` from [GitHub Releases](https://gitlab.com/hypernexus-org/HyperNexus/releases)
...
- [GitHub Issues](https://gitlab.com/hypernexus-org/HyperNexus/issues)
