...
// MemoryCategory distinguishes the kind of knowledge stored
// Based on LangMem's three-tier memory and Hindsight's biomimetic model
const (
	CategorySemantic   = "semantic"   // Facts, knowledge, general information
	CategoryEpisodic   = "episodic"   // Specific interaction memories, events
	CategoryProcedural = "procedural" // How-to knowledge, patterns, workflows
)
