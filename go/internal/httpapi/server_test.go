...
func TestGitLogFallsBackLocally(t *testing.T) {
	// Override git identity env vars to match test expectations
	t.Setenv("GIT_AUTHOR_NAME", "hypernexus Test")
	t.Setenv("GIT_AUTHOR_EMAIL", "test@hypernexus.local")
	t.Setenv("GIT_COMMITTER_NAME", "hypernexus Test")
	t.Setenv("GIT_COMMITTER_EMAIL", "test@hypernexus.local")
