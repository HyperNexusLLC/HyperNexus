...
// GetProductName returns the display name based on corporate mode
...
// GetCompanyName returns the company name based on corporate mode
func GetCompanyName() string {
	if IsCorporateMode() {
		return "HyperNexus Corp"
	}
	return "TormentNexus Team"
}

// GetDashboardTitle returns the dashboard title based on corporate mode
func GetDashboardTitle() string {
	if IsCorporateMode() {
		return "HyperNexus Dashboard"
	}
	return "TormentNexus Dashboard"
}

// GetTrayTooltip returns the tray tooltip based on corporate mode
func GetTrayTooltip() string {
	if IsCorporateMode() {
		return "HyperNexus (Running)"
	}
	return "TormentNexus (Running)"
}
