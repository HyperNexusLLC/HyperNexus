...
import (
	...
	"gitlab.com/HyperNexusLLC/HyperNexus/agents"
	"gitlab.com/HyperNexusLLC/HyperNexus/foundation/adapters"
	foundationorchestration "gitlab.com/HyperNexusLLC/HyperNexus/foundation/orchestration"
...
func handleRepoMap(m *model) (tea.Model, tea.Cmd) {
	m.loading = false
	result, err := foundationrepomap.Generate(context.Background(), foundationrepomap.Options{BaseDir: m.director.WorkingDir, MaxFiles: 12})
	if err != nil {
