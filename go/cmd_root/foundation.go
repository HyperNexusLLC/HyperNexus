...
import (
	...
	"gitlab.com/HyperNexusLLC/HyperNexus/foundation/assimilation"
	"gitlab.com/HyperNexusLLC/HyperNexus/foundation/compat"
	foundationpi "gitlab.com/HyperNexusLLC/HyperNexus/foundation/pi"
	"gitlab.com/HyperNexusLLC/HyperNexus/foundation/repomap"
...
var foundationRepomapCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		result, err := repomap.Generate(context.Background(), repomap.Options{
			BaseDir:         baseDir,
